...
*/
...

    {
        ...
        $this->db->join('patient_tbl', 'patient_tbl.patient_id = estimates.patient_id '); 

        $this->db->where('estimates.doctor_id',$this->session->userdata('doctor_id'));
