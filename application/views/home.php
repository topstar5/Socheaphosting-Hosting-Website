        ...
        <nav class="navbar navbar-default">
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?php echo base_url();?>"><img src="<?php echo (!empty($info->logo->picture)?$info->logo->picture:null); ?>" class="img-responsive" alt=""></a>
                ...
                <div class="row">
                   ...
                   <?php if(!empty($info->third_party_api->details)){
                    ...
                    ?>
                                        ...
                                        <input type="submit" class="btn btn-blue btn-block" value="<?php echo display('appointment');?>">
                                    <?php echo form_close();?>
                                </div>
