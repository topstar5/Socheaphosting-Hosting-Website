...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <div class="header-title">
            ...
            <h1><?php echo display('estimates_list')?></h1>

            <small><?php echo display('estimates_list')?></small>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-xs btn-default" target="_blank" href="<?php echo base_url();?>admin/Prescription_controller/estimates_list"><i class="fa fa-eye"></i> View</a>
                                    <a class="btn btn-xs btn-default" target="_blank" href="<?php echo base_url();?>admin/Prescription_controller/estimates_list"><i class="fa fa-envelope"></i> Email</a>
                                    <br><br>
                                    <a class="btn btn-xs btn-primary" target="_blank" href="<?php echo base_url();?>admin/Prescription_controller/estimates_list"><i class="fa fa-check"></i> Convert to Invoice</a>
