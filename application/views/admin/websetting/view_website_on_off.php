            ...
            <div class="panel panel-bd">
                ...
                <div class="panel-body">
                    <div class="portlet-body form">
                               <div class="form-body">
                       <?php 
                            $attributes = array('class' => 'form-horizontal form-inline','method'=>'post','role'=>'form');
                            echo form_open('admin/Web_setup_controller/patient_id_prefix', $attributes);   
                      ?>
                                   Prefix: <input type="text" name="patient_id_prefix" class="form-control" value="<?php echo $patient_id_prefix; ?>" />
                                   <?php echo form_dropdown('patient_id_auto_generate', array('on' => 'Enable Auto Generate Patient ID', 'off' => 'Disable Auto Generate Patient ID'), $patient_id_auto_generate, 'class="form-control"'); ?>
