                        ...
                        <div class="portlet-body form">
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-5">
                                        <input type="text" id="search-box" class="form-control" value="<?php  echo $medicine->company_name; ?>" placeholder="<?php echo display('company_name');?>" required />
                                        <input type="hidden"  name="company_id" id="search-company_id" value="<?php  echo $medicine->med_company_id; ?>" />
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-5">
                                       <input type="text" name="group_id" id="search-group" value="<?php  echo $medicine->group_name; ?>" class="form-control" placeholder="<?php echo display('group_name');?>" required />
                                       <input type="hidden" name="group_id" id="search-group_id" value="<?php  echo $medicine->med_group_id; ?>" />
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-5">
                                         <textarea name="description"  class="form-control" rows="6"><?php  echo $medicine->med_description; ?></textarea>
                                    </div>
                                </div>
