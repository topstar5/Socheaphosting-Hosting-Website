            ...
            <div  class="panel panel-default">
                <div class="panel-body">
                     <table class="table table-bordered table-hover dt-responsive" id="prescription_list" cellspacing="0" width="100%">
                            <thead>
                                <tr>
                                    <th class="all"><?php echo display('venue_name');?></th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-danger" href="<?php echo base_url();?>admin/print_pattern/Print_pattern_controller/delete_setup/<?php echo $value->id; ?>"><i class="fa fa-trash"></i></a>
                                    </td>
                                </tr>
                                <?php } ?>
                            </tbody>
