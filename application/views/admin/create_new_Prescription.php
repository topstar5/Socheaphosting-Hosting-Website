    ...
    <section class="content">
         ...
         <div class="row">
             <?php 
                ...
                echo form_open_multipart('admin/Prescription_controller/new_prescriptions_save', $attributes);
             ?>
                    <div class="col-md-12">
                        ...
                        <!--  -->
                                <div class="portlet-title">
                                   <div class="row">
                                    ...
                                    <div class="portlet-title">
                                         <div class="form-group ">
                                            <div class="col-md-6"><input type="text" class="form-control"  placeholder="<?php echo display('patient_cc')?>" name="Problem" /></div>
                                                                ...
                                                                <td> 
                                                                    <div class="field_wrapper1">
                                                                        ...
                                                                        <div class="form-group ">
                                                                            ...
                                                                            <div class="col-md-5"> 
                                                                                <input placeholder="<?php echo display('description')?>" name="test_description[]" class="form-control" ><samp> <?php echo display('discription')?></samp>
                                                                            </div>
                                                                                <a href="javascript:void(0);" class=" btn btn-danger remove_button" title="Remove field"><span class="glyphicon glyphicon-trash"></span></a>
                                                                        </div>
                                                                    </div>
