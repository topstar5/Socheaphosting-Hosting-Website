                                ...
                                <tr <?php echo ($result>0)?'style="background-color: rgb(19, 203, 21)"':''?> >
                                    ...
                                    <td>
                                     ...
                                     <?php if($Payment!=NULL){?>
                                        ...
                                        <?php } else{ ?>
                                        <a class="btn btn-sm btn-danger" target="_blank" href="<?php echo base_url();?>admin/payment_method/Payment/pay_with_doctor/<?php echo $value->appointment_id;?>"> Not Paid</a>
