        ...
        <div class="header-right-info pull-left clearfix">
            <div class="single-header-info">
                <h4>
                    ...
                    <strong><?php echo display('patient_name');?> : </strong><?php echo $p_info->patient_name;?></p>
                                ...
                                <table  class="table table-bordered table-hover">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <?php } else{?>
                                                <a class="btn btn-xs btn-info" target="_blank" href="<?php echo base_url();?>admin/Generic_controller/generic/<?php echo $value1->prescription_id; ?>"><?php echo $value1->appointment_id;?></a>
                                            <?php } ?>
