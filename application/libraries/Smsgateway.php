<?php
    class Smsgateway
    {
            ...
            switch (strtolower($config['apiProvider'])) {
                ...
                case 'nexmo':
                 ...
                 case 'clickatell':
                    ...
                    break;
                // MSG91 Gateway Message Sending Case 
                 case 'msg91':
                        return $this->send_msg91_message($config);
                    break;
        ...
        // MSG91 Gateway Message Sending

        #--------------------------------------------       
        public function send_msg91_message($config = [])
        {

                $MessageAPI_URL         = 'https://control.msg91.com/api/sendhttp.php';
                $MessageAPI_Configs     = array(
                ...
                $params['mobiles']  = '91'.$config['to']; 
                $params['message']  = $config['message']; 
                
                $url = $MessageAPI_URL;
                
                $params = array_merge($MessageAPI_Configs, $params);
